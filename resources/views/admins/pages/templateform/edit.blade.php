            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('admin.form_template.update.template', ['id' => $template->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12 mt-3" style="display: flex !important;flex-direction: column;">
                                    ...
                                    <select name="status" id="status-select" class="form-control ">
                                        ...
                                        <option {{ $template->status == 'active' ? 'selected' : '' }} value="active">Hoạt động</option>
                                        <option {{ $template->status == 'unactive' ? 'selected' : '' }} value="unactive" >Không hoạt động</option>
                                    </select>
