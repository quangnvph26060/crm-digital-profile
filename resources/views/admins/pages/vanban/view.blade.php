                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3" id="pdf-preview-container" style="display:none;">
                                                <label class="form-label">Xem PDF - <a
                                                        href="{{ asset('storage/' . $vanban->duong_dan) }}">Link</a></label>
                                                <iframe id="pdf-preview" style="width: 100%; height: 850px;"
                                                    frameborder="0"></iframe>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 no-edit ">
                                            <div class="row mb-3">
...
document.addEventListener("DOMContentLoaded", function() {
    const pdfPath = `{{ asset('storage/duong_dan/' . $vanban->duong_dan) }}`;
