            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('admin.profile.updateHoSo', ['id' => $template->id]) }}" method="POST"
                                    ...
                                    <div>
                                        ...
                                        <div class="col-lg-12 mt-3" style="display: flex !important;flex-direction: column;">
                                            ...
                                            <select name="status" id="status-select" class="form-control ">
                                                <option value="active" {{$template->status == 'active' ? "selected" :""}} >Hoạt động</option>
                                                <option value="unactive"  {{$template->status == 'unactive' ? "selected" :""}}>Không hoạt động</option>
                                            </select>
