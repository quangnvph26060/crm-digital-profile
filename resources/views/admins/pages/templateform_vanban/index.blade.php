                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ isset($inputs['name_form']) ? $inputs['name_form'] : '' }}"
                                            autocomplete="off" name="name_form" placeholder="Tên Form và Template Form"
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-success"
                                            href="{{ route('admin.form_template_vanban.add.template') }}">
                                            <i class="fas fa-plus"></i> Thêm mới
                                        </a>
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="container">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.form_template_vanban.updatestatus.template', ['id' => $item->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <label class="switch">
                                                ...
                                                <td class="d-flex gap-1">
                                                    <a href="{{ route('admin.form_template_vanban.edit.template', ['id' => $item->id]) }}"
                                                        class="btn btn-warning">
                                                        <img src="{{ asset('svg/detail.svg') }}" alt="SVG Image">
                                                    </a>
                                                    <form method="post"
                                                        action="{{ route('admin.form_template_vanban.delete.template', ['id' => $item->id]) }}"
