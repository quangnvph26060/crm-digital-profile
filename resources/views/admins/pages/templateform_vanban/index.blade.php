                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-success" href="{{route('admin.form_template_vanban.add.template')}}">
                                            <i class="fas fa-plus"></i> Thêm mới
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="container">
                                                    ...
                                                    <form action="{{ route('admin.form_template_vanban.updatestatus.template', ['id' => $item->id]) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <label class="switch">
                                            ...
                                            <td class="d-flex gap-1">
                                                ...
                                                <form method="post" action="{{ route('admin.form_template_vanban.delete.template', ['id' => $item->id]) }}" onsubmit="return confirm('Bạn có chắc chắn muốn xóa?');">
                                                    @csrf
                                                    @method('DELETE')
