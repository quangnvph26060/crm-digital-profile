            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('admin.form_template_vanban.update.template', ['id' => $template->id]) }}" method="POST"
                                    ...
                                    <div>
                                        ...
                                        <div class="col-lg-12 mt-3" style="display: flex !important;flex-direction: column;">
                                            ...
                                            <select name="status" id="status-select" class="form-control ">
                                                <option {{ $template->stauts== "active" ? 'selected' : '' }} value="active">Hoạt động</option>
                                                <option {{ $template->stauts== "unactive" ? 'selected' : '' }} value="unactive" >Không hoạt động</option>
                                            </select>
