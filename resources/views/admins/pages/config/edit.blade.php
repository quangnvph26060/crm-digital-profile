                                        ...
                                        <div>
                                            ...
                                            <div class="mb-3">
                                                <label for="example-url-input" class="form-label">Tên phông <span
                                                        class="text text-danger">*</span></label>
                                                <input value="{{ $config->font_name }}" required class="form-control"
                                                    name="font_name" type="text" id="example-email-input" readonly>
                                                @error('font_name')
                                                    <div class="invalid-feedback d-block">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="example-url-input" class="form-label">Mã phông<span
                                                    class="text text-danger">*</span></label>
                                            <input value="{{ $config->font_code }}" required class="form-control"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="toc_name" class="form-control" data-trigger
                                                ...
                                                <option value="Vĩnh viễn" {{$config->toc_name === "Vĩnh viễn" ? "selected" :""}}>Vĩnh viễn</option>
                                                <option value="Có thời hạn" {{$config->toc_name === "Có thời hạn" ? "selected" :""}}>Có thời hạn</option>
                                            </select>
                                            @error('toc_name')
                                                <div class="invalid-feedback d-block">
                                                    {{ $message }}
