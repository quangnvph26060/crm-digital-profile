            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ route('admin.vanban.index') }}" >
                        ...
                        <span data-key="t-apps">Tài liệu/ Văn bản</span>
                    </a>
                </li>
                @if (auth('admin')->user()->level === 2)
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li>
                                <a href="{{ route('admin.coquan') }}">
                                    <span data-key="t-chat">Cơ quan</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.phong.index') }}">
                                    <span data-key="t-chat">Phông lưu trữ</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.mucluc.index') }}">
                                    <span data-key="t-chat">Mục lục lưu trữ</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.mucluc.index') }}">
                    ...
                    @if (auth('admin')->user()->level === 2)
                        <li>
                            <a href="{{ route('admin.thongtinhoso') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><path d="M16 2v4M8 2v4m-5 4h18"/></g></svg>
                                <span data-key="t-chat">Trường thông tin hồ sơ</span>
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('admin.column') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><path d="M16 2v4M8 2v4m-5 4h18"/></g></svg>
                                <span data-key="t-chat">Trường thông tin văn bản</span>
                            </a>
                        </li>
                    @endif
                    ...
                    <li>
                        ...
                        <a href="{{ route('admin.list') }}">
                            ...
                            <span data-key="t-chat">Người dùng</span>
                        </a>
                    </li>
